...
@interface WebServiceHttpClient : AFHTTPRequestOperationManager
...
/*
 ...
 协议例子：
 www.ourgift.cn:8080/books/api/index.php?act=books.ctalog.get
 返回字段说明：
 catalog_id 		分类ID
 catalog_name		分类名称
 */
...
/*
 ...
 协议例子：
 www.ourgift.cn:8080/books/api/index.php?act=books.booksList.get&catalog_id=22&page=1
...
/*
 ...
 协议例子：
 www.ourgift.cn:8080/books/api/index.php?act=books.bookDetail.get&book_id=7504
 参数说明：
 book_id			小说id 必填
 返回字段说明：
 book_id				小说id
...
/*
 ...
 协议例子：
 www.ourgift.cn:8080/books/api/index.php?act=books.bookChapters.get&book_id=7504&page=5
 参数说明
 book_id			小说id 必填
 page         	页数  非必填  默认为1
...
/*
 ...
 协议例子：
 www.ourgift.cn:8080/books/api/index.php?act=books.bookChapterContent.get&chapter_id=7705&book_id=7504
 参数：
 book_id			小说ID  必填项
 chapter_id		章节ID  必填项
 返回字段说明：
...
/*8.	获取排行榜
 ...
 协议例子：
 http://www.ourgift.cn:8080/books/api/index.php?act=books.chartsList.get
 参数：
 无
 返回字段说明：
...
/*
 ...
 协议例子：
 http://www.ourgift.cn:8080/books/api/index.php?act=books.chartsBookList.get&chart_key=all_click&page=1
...
/*
 ...
 协议例子：
 推荐小说列表
 http://www.ourgift.cn:8080/books/api/index.php?act=books.recommendBookList.get&list_type=recommend&page=1
 感兴趣小说列表
 http://www.ourgift.cn:8080/books/api/index.php?act=books.recommendBookList.get&list_type=interest&page=1
 参数：
